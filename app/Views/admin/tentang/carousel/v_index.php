            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tentang Carousel</h4>
                    </div>
                    <div class="card-body table-responsive">
                        <a class="btn btn-sm btn-icon btn-info mb-3" href="<?= base_url('tentang_carousel/create') ?>">Tambah Data</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group mb-3 btn-group-sm" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-primary" onclick="window.location.href='<?= base_url('/tentang_carousel/edit/' . $value['id']) ?>';">Edit</button>
                                                <form method="post" action="<?= base_url('/tentang_carousel/delete/' . $value['id']) ?>" class="d-inline">
                                                    <?= csrf_field(); ?>
