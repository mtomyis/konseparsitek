...
<head>
  ...
  <!-- <link rel=stylesheet href=http://ds.konseparsitek.com/demo-only/demo-css/general.css type=text/css />
    <link rel=stylesheet href=http://ds.konseparsitek.com/mibreit-gallery/css/mibreitGallery.css type=text/css />
    <script src=https://code.jquery.com/jquery-3.5.1.min.js integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin=anonymous></script>
    <script src="http://ds.konseparsitek.com/mibreit-gallery/mibreitGallery.min.js"></script>
    <script>$(document).ready(function(){mibreitGallery.createGallery({
        slideshowContainer:"#full-gallery",thumbviewContainer:".mibreit-thumbview",titleContainer:"#full-gallery-title",allowFullscreen:!0,preloadLeftNr:2,preloadRightNr:3
        })})</script> -->
